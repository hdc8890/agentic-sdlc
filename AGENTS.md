...
4. `docs/specs/interface-contracts.md`
5. `docs/specs/evaluation-promotion.md`
6. `docs/specs/versioning.md`
7. `governance/conformance.md`
...
- `examples/adapters/`: reserved for framework-specific adapters that demonstrate conformance.
