...
5. `contracts/v1/profile.schema.json`
6. `contracts/v1/policy.schema.json`
7. `governance/working-group.md`
...
- `docs/architecture/`: layer model and brownfield integration architecture
